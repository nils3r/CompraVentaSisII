...
public class Farticulo {
    ...
    public DefaultTableModel mostrar(String buscar) {
        ...
        String cc="SELECTO a.id, a.id_categoria, c.nombre as categoria_nombre, a.codigo, a.nombre, a.precio_venta, a.stock, a.descripcion, a.imagen FROM articulo a inner categoria c ON a.id_categoria=c.id WHERE a.nombre LIKE '%" + buscar + "%'";
        try {
